...
SP_Ops decode(const SP_Type data)
{
  ...
  else if (data.instr.add.op == 0)
  {
    ...
    if (opts.instrs)
    {
      ...
      {
        cout << " r" << setbase(10) << data.instr.add.rd << ", r" << setbase(10) << data.instr.add.rd << ", r" << setbase(10) << data.instr.add.rm << endl;
      }
    }
    return SP_ADD;
  }
  else if (data.instr.cmp.op == 1)
  {
    ...
    if (opts.instrs)
    {
      ...
      if (data.instr.cmp.d)
      {
        ...
        {
          cout << " r" << setbase(10) << (8 + data.instr.cmp.rd) << ", r" << data.instr.cmp.rm <<endl;
        }
      }
      // another stack pointer case
